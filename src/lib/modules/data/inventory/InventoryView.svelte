...
<div class="flex flex-col gap-5">
    ...
    {#each inventoryStats as stat}
      ...
      >
        <div class="flex justify-between items-start">
          ...
          <span
            class="text-[11px] font-semibold px-2 py-0.5 rounded-full {stat.trendDir ===
            'up'
  ...
  >
    <div
      class="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg flex-1 max-w-100"
    >
    ...
    <button
      class="flex items-center gap-1.5 p-3 border border-gray-200 rounded-lg text-[13px] text-gray-600 bg-white cursor-pointer hover:border-[#0B182A] transition-colors duration-150"
    >
      <Icons.Cube size={14} />
      Category
          ...
          {#each items as item}
            ...
            >
              <td class="py-3 px-3 text-[#E87D1F] font-medium text-[13px]"
                >{item.id}</td
              >
              <td class="py-3 px-3 text-[13px] text-gray-700 font-medium"
                >{item.name}</td
              >
              ...
              <td class="py-3 px-3">
                <span
                  class="text-[11px] font-semibold px-2.5 py-1 rounded-full {item.status ===
                  'Active'
                    ? 'bg-green-50 text-green-600'
