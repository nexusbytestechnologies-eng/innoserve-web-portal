  ...
  >
    ...
    <div class="flex items-start justify-between px-6 py-4 border-b border-gray-100 shrink-0">
      <div class="flex items-center gap-3">
        <div class="w-10 h-10 rounded-xl bg-[#0B182A]/5 flex items-center justify-center shrink-0">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0B182A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
            <polyline points="9 22 9 12 15 12 15 22"/>
          </svg>
        </div>
        <div>
          <h2 class="text-[16px] font-semibold text-[#0B182A] leading-tight">{customer.companyName}</h2>
          <span class="text-[11px] font-semibold px-2 py-0.5 rounded-full {statusStyle(customer.status)}">
      ...
      <button
        onclick={onClose}
        class="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 transition-colors text-gray-400 hover:text-gray-600 shrink-0"
        aria-label="Close"
      >
    ...
    <div class="px-6 py-5 flex flex-col gap-5 overflow-y-auto">
      ...
      <!-- Primary Contact -->
      <div>
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-3">Primary Contact</p>
      ...
      <div class="border-t border-gray-100 pt-4">
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-3">Address</p>
      ...
      {#if customer.secondaryContactName || customer.secondaryContactEmail || customer.secondaryContactPhone}
        <div class="border-t border-gray-100 pt-4">
          <p class="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-3">Secondary Contact</p>
          <div class="grid grid-cols-2 gap-x-6 gap-y-4">
            <div class="col-span-2">
